...
for script in codexbar-popup-launch.sh codexbar-tray.py codexbar-tray.svg codexbar_paths.py; do
    install -m 0755 "$SCRIPT_DIR/$script" "$WAYBAR_CONF/scripts/$script"
done
